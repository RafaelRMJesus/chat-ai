...
export const PersonForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      if (initialData) {
        await axios.patch(`/api/person/${initialData.id}`, values);
      } else {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 pb-10">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your AI Personality will be named.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Short description for your AI Personality
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Describe in detail your personality&apos;s backstory and relevant details.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="w-full flex justify-center">
            <Button size="lg" disabled={isLoading} onClick={form.handleSubmit(onSubmit)}>
              {initialData ? "Edit your personality" : "Create your personality"}
